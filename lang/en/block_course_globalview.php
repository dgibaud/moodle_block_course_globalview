...
/**
 * Lang strings for course_globalview block
 *
...
$string['activityglobalview'] = 'You have {$a}s that need attention';
...
$string['course_globalview:addinstance'] = 'Add a new course globalview block';
$string['course_globalview:myaddinstance'] = 'Add a new course globalview block to My home';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on course globalview block, 0 will show all courses';
...
$string['pluginname'] = 'Course globalview';
...
$string['showfiles'] = 'Afficher les fichiers et forums :';
$string['showfilesyes'] = 'Oui';
$string['showfilesno'] = 'Non';
$string['showfilesdisplay'] = 'Affichage';

$string['nocourses'] = 'Vous n\'êtes inscrit(e) dans aucun cours.';
